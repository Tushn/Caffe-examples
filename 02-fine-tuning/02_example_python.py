#~ sudo ../../../anaconda3/bin/python3.6 01_example_lenet.py 
# exec(open('02_example_python.py').read())
...
#!python ./finetune_flickr_style/assemble_data.py --workers=-1  --seed=1701 --images=$NUM_STYLE_IMAGES  --label=$NUM_STYLE_LABELS
## alternativa code downloaded from internet
#!python ./finetune_flickr_style/assemble_data2.py ../../data/flickr_style/images ../../data/flickr_style/train.txt ../../data/flickr_style/test.txt 20
# back to examples
os.chdir('examples')
...
style_solver_filename = solver(style_net(train=True).encode())
